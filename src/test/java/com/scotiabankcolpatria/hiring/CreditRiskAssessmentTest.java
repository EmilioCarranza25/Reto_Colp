...
public class CreditRiskAssessmentTest {
    ...
    public void maxPeakTest1() {
        CreditRiskAssessment riskAssessment = new CreditRiskAssessment();
        int index = riskAssessment.paymentDelayMaxPeakIndex(new int[]{5, 4, 2, 2, 0, 10, 9, 3});
    ...
    public void maxPeakTest3() {
        CreditRiskAssessment riskAssessment = new CreditRiskAssessment();
        int index = riskAssessment.paymentDelayMaxPeakIndex(new int[]{0, 1, 1, 2, 0, 0, 0, 0});
    ...
    public void maxPeakTest4() {
        CreditRiskAssessment riskAssessment = new CreditRiskAssessment();
        int index = riskAssessment.paymentDelayMaxPeakIndex(new int[]{2, 3, 0, 4, 3, 0, 0, 3});
        Assertions.assertEquals(3, index);
    }
    ...
    public void latePaymentProbabilityByPeriodTest1() {
        ...
        Assertions.assertArrayEquals(null, probabilities);
    }
